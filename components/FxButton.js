...
export function fxButtonClassName({ className, variant = "primary", size = "md" } = {}) {
  return cn(
    `inline-flex cursor-pointer items-center justify-center gap-[8px] ${FX_RADIUS.xs} ${FX_TYPE.button} whitespace-nowrap transition-none disabled:cursor-not-allowed disabled:opacity-70 disabled:hover:bg-inherit`,
...
export function fxIconButtonClassName({ className, variant = "outline", size = "md" } = {}) {
  return cn(
    `inline-flex cursor-pointer items-center justify-center ${FX_RADIUS.xs} transition-none disabled:cursor-not-allowed disabled:opacity-70 disabled:hover:bg-inherit`,
    "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background",
    variantClasses[variant],
