...
export const TYPE = {
  ...
  navTitle: "text-[28px] leading-[36px] font-semibold",
  workspaceTitle: "text-[28px] leading-[36px] font-semibold",
  ...
  fieldLabel: "text-[13px] leading-[20px] font-medium",
  fieldHint: "text-[13px] leading-[20px] font-normal",
  input: "text-[14px] leading-[22px] font-normal",
  tableHeader: "text-[12px] leading-[18px] font-medium uppercase",
  ...
  sheetTitle: "text-[22px] leading-[28px] font-medium",
  ...
  dropdownHeader: "text-[12px] leading-[18px] font-medium uppercase",
...
export const NAVIGATION = {
  itemBase: "group relative flex h-[40px] items-center overflow-hidden rounded-[8px] px-[8px] transition-colors",
  ...
  iconSlot: "flex w-[36px] shrink-0 items-center justify-center",
  ...
  footerButton:
    "flex w-full cursor-pointer items-center overflow-hidden rounded-[12px] px-[8px] py-[8px] text-left hover:bg-[var(--fx-surface-hover)]",
...
export const LAYOUT = {
  ...
  sidebarExpandedWidth: "w-[256px]",
  sidebarCollapsedWidth: "w-[72px]",
  accountMenuWidth: "!min-w-[256px] !rounded-[16px]",
  sidebarExpandedOffset: "pl-[256px]",
  sidebarCollapsedOffset: "pl-[72px]",
  navbarHeight: "h-[64px]",
