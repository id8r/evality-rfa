...
export const SHEET = {
  ...
  widthMd: "w-[520px] max-w-none",
  widthLg: "w-[720px] max-w-none",
  widthXl: "w-[78vw] max-w-none",
...
export const PANEL = {
  dialogWidth: "max-w-[460px]",
  dialogBodyPadding: "p-[48px]",
  dialogGap: "gap-[32px]",
  dialogRadius: "sm:rounded-[16px]",
  dialogTransition: "duration-[220ms] ease-out",
