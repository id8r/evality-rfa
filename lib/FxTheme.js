...
import { SIDEBAR_DIMENSIONS } from "@/lib/FxConstants";
...
export const LAYOUT = {
  ...
  sidebarExpandedWidth: `w-[${SIDEBAR_DIMENSIONS.EXPANDED}px]`,
  sidebarCollapsedWidth: `w-[${SIDEBAR_DIMENSIONS.COLLAPSED}px]`,
  accountMenuWidth: `!w-[${SIDEBAR_DIMENSIONS.EXPANDED}px] !min-w-[${SIDEBAR_DIMENSIONS.EXPANDED}px] !rounded-[16px]`,
  sidebarExpandedOffset: `pl-[${SIDEBAR_DIMENSIONS.EXPANDED}px]`,
  sidebarCollapsedOffset: `pl-[${SIDEBAR_DIMENSIONS.COLLAPSED}px]`,
  navbarHeight: "h-[64px]",
