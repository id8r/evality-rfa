...
export const TYPE = {
  ...
  /* App-level page and workspace headers */
  ...
  /* Form and field copy */
  fieldLabel: "text-[14px] leading-[20px] font-normal",
  fieldHint: "text-[13px] leading-[20px] font-normal",
  input: "text-[15px] leading-[22px] font-normal",

  /* Table typography */
  tableHeader: "text-[14px] leading-[20px] font-medium",
  tableCell: "text-[15px] leading-[22px] font-normal",
  clickableData: "text-[15px] leading-[22px] font-medium",
  ...
  sheetTitle: "text-[16px] leading-[24px] font-semibold",
  sheetSubtitle: "text-[13px] leading-[20px] font-normal",
  dialogTitle: "text-[20px] leading-[32px] font-semibold",
...
export const PILL = {
  ...
  full: "rounded-full px-[10px] py-[3px] text-[12px] leading-[16px]",
  rect: "rounded-[2px] px-[8px] py-[2px] text-[12px] leading-[16px]",
};
...
export const SHEET = {
  ...
  widthSm: "w-[480px] max-w-none",
  widthMd: "w-[540px] max-w-none",
  widthLg: "w-[600px] max-w-none",
  widthXl: "w-[660px] max-w-none",
  widthFull: "w-[calc(100vw-96px)] max-w-none",
  openDurationMs: 280,
  closeDurationMs: 220,
...
export const TABLE = {
  ...
  headerCell:
    "h-[48px] border-b border-[var(--fx-border)] px-[16px] py-0 align-middle text-left text-[var(--fx-text-muted)] bg-[var(--fx-table-header)]",
  bodyCell:
    "border-b-[0.5px] border-[color:color-mix(in_srgb,var(--fx-border)_34%,transparent)] px-[16px] py-[8px] align-middle text-[var(--fx-text)]",
  row: "odd:bg-[var(--fx-surface)] even:bg-[var(--fx-table-row-alt)] hover:bg-[var(--fx-surface-hover)]",
