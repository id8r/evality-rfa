...
export const PAGE_PADDING_Y = 40;
...
export const PAGE_PADDING_X_CLASS = "px-[40px]";
export const PAGE_PADDING_Y_CLASS = "py-[40px]";

export const SIDEBAR_EXPANDED_WIDTH_CLASS = "w-[260px]";
export const SIDEBAR_COLLAPSED_WIDTH_CLASS = "w-[72px]";
export const ACCOUNT_MENU_WIDTH_CLASS = "!min-w-[260px] !rounded-[16px]";
...
export const STORAGE_KEYS = {
  ...
  JOBS: "evality_jobs",
  JOBS_DEMO_MODE: "evality_jobs_demo_mode",
