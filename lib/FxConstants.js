...
export const STORAGE_KEYS = {
  ...
  AUTH_PROVIDER: "evality-auth-provider",
  AUTH_EMAIL: "evality-auth-email",
  ...
  ORGANIZATION_PROFILE: "evality-organization-profile",
...
export const SCREENING_METHOD_OPTIONS = [
  ...
  { value: "phone", title: "AI Phone Call", description: "Run AI-led phone screening.", disabled: true },
