...
export const NAV_ITEMS = [
  ...
  { id: "jobs", label: "Jobs", href: "#", icon: "fileText", disabled: true },
  { id: "candidates", label: "Candidates", href: "#", icon: "users", disabled: true },
  { id: "clients", label: "Clients", href: "#", icon: "folderOpen", disabled: true },
  { id: "action-center", label: "Action Center", href: "#", icon: "inbox", disabled: true },
];

export const DEMO_USER = {
  name: "Demo Recruiter",
  email: "demo@evality.ai",
};
...
export const WELCOME_COPY = {
  ...
  DESCRIPTION: "Who are you hiring for?",
...
export const CONTENT_MAX_WIDTH_CLASS = "max-w-[1200px]";
...
export const LAYOUT = {
  ...
  APP_CONTENT: `w-full ${CONTENT_MAX_WIDTH_CLASS} ${PAGE_PADDING_X_CLASS} ${PAGE_PADDING_Y_CLASS}`,
};
