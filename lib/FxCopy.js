...
export const ONBOARDING_COPY = {
  ...
  question: "What best describes how you recruit?",
  options: [
    {
      id: "independent-recruiter",
      title: "Independent Recruiter",
      description: "Hire for multiple clients and manage recruiting independently.",
    },
    {
      id: "recruiting-agency",
      title: "Recruiting Agency",
      description: "Collaborate with clients, manage multiple jobs, and track candidate submissions.",
    },
    {
      id: "internal-talent-team",
      title: "Internal Hiring Team",
      description: "Manage hiring for your company and coordinate recruitment internally.",
    },
  ],
};
