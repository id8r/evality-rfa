  ...
  purposeOptions: [
    {
      value: "internal",
      title: "My Company",
      description: "Hiring for your own organization",
    },
    {
      value: "agency",
      title: "Clients",
      description: "Recruiting for external clients or companies",
    },
    {
      value: "both",
      title: "Both",
      description: "Managing internal and client hiring",
    },
  ],
  helperText:
...
export const PAGE_COPY = {
  ...
  jobs: {
    ...
    editCta: "Edit Job",
    searchPlaceholder: "Search Job or Location...",
    activeTab: "Active",
    ...
    sheetCreateDescription: "Set the role skeleton before expanding the rest of the workflow.",
    sheetEditDescription: "Update the role skeleton before refining downstream steps.",
  },
  candidates: {
    title: "Candidates",
  ...
  jobWorkspace: {
    ...
    notFoundBody: "This route only resolves jobs that exist. Return to Jobs and recreate the role from the table.",
