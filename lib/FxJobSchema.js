...
export const DEFAULT_JOB_QUESTION_SUGGESTIONS = [
  ...
  },
  {
    ...
    question: "What is your preferred work location or commute range for this role?",
...
export function createJobFormFromJob(job) {
  ...
  return {
    ...
    preScreeningMode: data.preScreeningMode ?? "phone",
...
export function serializeJobFormToRecord({ form, existingJob = null, includeClientInfo = true, updatedBy = "John Doe" }) {
  ...
  const nextRecord = {
    ...
    data: {
      ...
      preScreeningMode: form.preScreeningMode || "phone",
