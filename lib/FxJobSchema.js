...
export const DEFAULT_JOB_QUESTION_SUGGESTIONS = [
  ...
  },
  {
    ...
    question: "Do you require work authorization or visa sponsorship?",
    note: "Keep this only when relevant for the role.",
  },
  {
    id: "job-location",
    label: "Job Location",
    question: "Are you comfortable commuting to the job location?",
    note: "Use when location flexibility matters for the role.",
  },
  {
    id: "current-company",
  ...
  },
  {
    id: "job-type",
    label: "Job Type",
    question: "Are you comfortable with the employment type for this role?",
    note: "Useful when confirming contract or work-style fit.",
  },
];
/* - - - - - - - - - - - - - - - - */
...
export function createEmptyJobForm() {
  return {
    ...
    experienceFrom: "",
    experienceTo: "",
    hideCompensationFromCandidates: false,
    client: "",
    assignee: "John Doe",
    status: "Draft",
    aiPrompt: "",
